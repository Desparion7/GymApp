		...
		<section className='public'>
			{positiveServerMessage ? (
					...
					<div className='public__publicBox'>
						<form>
							...
							<input
								...
								className={userNameError ? 'formInput errorInput' : 'formInput'}
							/>
							...
							<input
								...
								className={emailError ? 'formInput errorInput' : 'formInput'}
							/>
							{emailInvalid && (
								<p className='errorText'>Format adresu jest nieprawidłowy</p>
							)}
							...
							{confirmPasswordError && (
								<p className='errorText'>Wprowadzone hasła nie zgadzają się</p>
							)}
							{serverErrorMessage && (
				...
				<>
					<div className='public__welcomeText'>
						<h2>
							Posiadasz dostęp do wszystkich funkcji <span>Menadżera treningu.</span>{' '}
						</h2>
					</div>
